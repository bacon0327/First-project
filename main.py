...
import whisper_bert_AIver3  # 語音辨識與指令解析模組
from ai_gomoku import GomokuAI  # 包含 AI 演算法與棋盤邏輯
import threading
import time
from tkinter import messagebox, scrolledtext
from whisper_bert_AIver3 import whisper_model, record_and_segment, normalize_text  # 引入必要方法
AUDIO_PATH = "mode_select.wav"
...
def auto_listen_loop():
    while True:
        result = whisper_bert_AIver3.run_once_and_return_json()
